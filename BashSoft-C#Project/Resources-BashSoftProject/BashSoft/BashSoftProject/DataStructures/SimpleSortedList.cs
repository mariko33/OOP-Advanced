...
namespace BashSoftProject.DataStructures
{
    public class SimpleSortedList<T> : ISimpleOrderedBag<T> where T : IComparable<T>
    {
        ...
        {
            if(element==null)throw new ArgumentNullException();
            if(this.size>=this.innerCollection.Length)this.Resize();
        ...
        public void AddAll(ICollection<T> collection)
        {
            ...
            if(this.Size+collection.Count>=this.innerCollection.Length)this.MultiResize(collection);
        ...
        public string JoinWhith(string joiner)
        {
            if(joiner==null)throw new ArgumentNullException();
            if(this.Size==0)throw new ArgumentNullException();
